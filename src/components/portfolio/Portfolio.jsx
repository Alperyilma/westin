            ...
            <div className="container">
                ...
                <div className="portfolio-items row">
                    <div className="col-md-6 col-lg-4 portfolio-item seo">
                        <PortfolioItem image="assets/img/portfolio-01.png" title="My Work"/>
                    </div>
                    <div className="col-md-6 col-lg-4 portfolio-item graphic webdesign">
                         <PortfolioItem image="assets/img/portfolio-02.png" title="My Work"/>
                    </div>
                    <div className="col-md-6 col-lg-4 portfolio-item webdesign graphic">
                         <PortfolioItem image="assets/img/portfolio-03.png" title="My Work"/>
                    </div>
                    <div className="col-md-6 col-lg-4 portfolio-item mobiledesign webdesign">
                        <PortfolioItem image="assets/img/portfolio-04.png" title="My Work"/>
                    </div>
                     <div className="col-md-6 col-lg-4 portfolio-item mobiledesign seo">
                        <PortfolioItem image="assets/img/portfolio-05.png" title="My Work"/>
                    </div>
                     <div className="col-md-6 col-lg-4 portfolio-item mobiledesign">
                        <PortfolioItem image="assets/img/portfolio-06.png" title="My Work"/>
                    </div>
                </div>
            </div>
        </section>
